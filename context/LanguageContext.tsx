...
const translations: Record<Language, Record<string, string>> = {
  ...
  ES: {
    ...
    hero_desc: 'Donde la tradición se encuentra con la modernidad. Experimenta el estándar LEVEL de enseñanza en un ambiente exclusivo diseñado para tu evolución soberana.',
    ...
    map_desc: 'Presente en los principales centros del mundo. Encuentra LEVEL y únete a la comunidad de élite.',
    ...
    footer_desc: 'Elevando el estándar global a través de una metodología de élite y un estilo de vida centrado en la soberanía humana.',
